...
<head>
    ...
    <title>Product Single | Domnoo Restaurant & Pizza HTML Template</title>
    <!-- Favicon -->
				...
				<section class="about-product-block new-block">
					<div class="container">
						<div class="block-stl7">
							<h4>About :</h4>
							<p>Quisque feugiat orci feugiat libero consequat, et elementum nisl finibus. Aenean eget dictum justo. Cras sollicitudin blandit scelerisque. Maecenas eleifend nibtempor lobortis. Phasellus tempus aliquet eros, ac faucibus ligula varius vel. Nulla sit amet molestie augue. Sed a consequat sapien, at interdum sapien. Phasellus ornare commodo libero vel aliquam. Nunc non ultricies eros. Curabitur pharetra enim quis nisi ultricies sagittis.</p>
							<p>Proin elementum erat a volutpat tristique. Aenean lectus metus, interdum quis posuere ut, tristique ut nunc. Vivamus at est vel risus vehicula bibendum. Nullam justo eros, vestibulum sed mauris ut, facilisis aliquet metus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean lacinia est ac orci malesuada cursus. Morbi vulputate tortor ac neque sodales, ac sodales tortor viverra.</p>
							<p>Curabitur risus ligula, malesuada sed elit eu, aliquet eleifend erat. Nulla in justo vitae orci condimentum fermentum. Nullam at finibus mi. Nulla porttitor augue at tellus lacinia volutpat. Donec vestibulum nec mi at lacinia. Duis vitae turpis convallis, lacinia nisi et, accumsan erat. In ullamcorper vestibulum massa, sed fringilla tortor finibus at. Proin eu ante non mauris eleifend aliquam sit amet quis arcu. Ut ut lorem vitae lectus porttitor porta. Etiam iaculis arcu quis bibendum hendrerit. Praesent convallis congue augue, sit amet varius dolor tristique sed. Ut tempor orci a egestas bibendum.</p>
						</div>
						<div class="review-slider">
							<div class="review_slider owl-carousel owl-theme">
								...
								<div class="item">
									<div class="block-stl8">
										<div class="img-holder">
											<img src="images/r_img2.png" alt="" class="img-responsive"> 
										</div>
										<div class="txt-block">
											<i class="flaticon-left-quote"></i>
											<p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Curabitur erat turpis posuere ac ante at</p>
								...
								<div class="item">
									<div class="block-stl8">
										<div class="img-holder">
											<img src="images/r_img3.png" alt="" class="img-responsive"> 
										</div>
										<div class="txt-block">
											<i class="flaticon-left-quote"></i>
											<p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Curabitur erat turpis posuere ac ante at</p>
