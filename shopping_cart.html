...
<head>
    ...
    <title>Shopping Cart | Domnoo Restaurant & Pizza HTML Template</title>
    <!-- Favicon -->
						...
						<div class="table-responsive">
							...
							<tbody>
								<tr>
									<td class="p_dtl">
										<div class="block-stl9">
											<div class="img-holder">
												<img src="images/p-img21.png" alt="" class="img-responsive">
											</div>
									...
									<td class="p_btn">
										<a href="#" class="btn1 stl3">Edit</a>
										<a href="#" class="btn1 stl3">Remove</a>
									</td>
									<td class="p_price">
										$6.00
									</td>
									<td class="p_quantity">
										<div class="quantity">
											<input type="number" class="form-control text-center" value="10" min="0">
										</div>
									</td>
									<td class="p_ttl">
										$28.00
								...
								<tr>
									<td class="p_dtl">
										<div class="block-stl9">
											<div class="img-holder">
												<img src="images/p-img22.png" alt="" class="img-responsive">
											</div>
											<div class="info-block">
												<h5>Veggie Supreme</h5>
												<p class="txt-cat">Regular</p>
									...
									<td class="p_quantity">
										<div class="quantity">
											<input type="number" class="form-control text-center" value="4" min="0">
										</div>
									</td>
									<td class="p_ttl">
										$28.00
								...
								<tr>
									<td class="p_dtl">
										<div class="block-stl9">
											<div class="img-holder">
												<img src="images/p-img23.png" alt="" class="img-responsive">
											</div>
											<div class="info-block">
												<h5>Veggie Supreme</h5>
												<p class="txt-cat">Regular</p>
									...
									<td class="p_quantity">
										<div class="quantity">
											<input type="number" class="form-control text-center" value="5" min="0">
										</div>
									</td>
									<td class="p_ttl">
										$28.00
								...
								<tr>
									<td class="p_dtl">
										<div class="block-stl9">
											<div class="img-holder">
												<img src="images/p-img24.png" alt="" class="img-responsive">
											</div>
											<div class="info-block">
												<h5>Veggie Supreme</h5>
												<p class="txt-cat">Regular</p>
								...
								<tr>
									<td class="p_dtl">
										<div class="block-stl9">
											<div class="img-holder">
												<img src="images/p-img25.png" alt="" class="img-responsive">
											</div>
											<div class="info-block">
												<h5>Veggie Supreme</h5>
												<p class="txt-cat">Regular</p>
