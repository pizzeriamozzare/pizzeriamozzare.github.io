...
<head>
    ...
    <title>Blog Right | Domnoo Restaurant & Pizza HTML Template</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <div class="bg-single">
                            <div class="bg-single-neww">
                                <div class="image-holder">
                                    <div class="holder-new">
                                        <div class="overlay"></div>
                                        <img src="images/habit2.jpg" alt="" class="img-responsive">
                                    </div>
                                    <ul>
                                ...
                                <div class="image-heading">
                                    <a href="blog_single.html"><h2>Mauris dapibus posuere sem ut congue.</h2></a>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed dapibus fermentum neque sagittis quam. Cras congue, sapien quis rutrum dapibus, orci justo blandit nequelorem eros viverra justo, sit amet fringilla risus risus tempus tortor. <a href="blog_single.html">continue reading</a></p>
                                </div>
                            </div>

                            <div class="bg-single-neww video-block">
                                <div class="image-holder">
                                    <div class="holder-new">
                                        <div class="overlay"></div>
                                        <img src="images/girl-blog.jpg" alt="" class="img-responsive">
                                        <a class="video" title="Why Us" href="https://www.youtube.com/watch?v=nrJtHemSPW4"> <i class="flaticon-video-player"></i></a>
                                    </div>
                                    <ul>
                                        <li><a href="#"><i class="flaticon-profile"></i>Shamiyo</a></li>
                                        <li><a href="#"><i class="flaticon-chat"></i>245 Coments</a></li>
                            ...
                            <div class="bg-single-neww sound-block">
                                <div class="image-holder">
                                    <div class="holder-new">
                                        <iframe src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/416436873&amp;color=%23ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;show_teaser=true"></iframe>
                                    </div>
                                    <ul>
                                        <li><a href="#"><i class="flaticon-profile"></i>Shamiyo</a></li>
                                        <li><a href="#"><i class="flaticon-chat"></i>245 Coments</a></li>
                            ...
                            <div class="bg-single-neww">
                                <div class="b_img_slider owl-carousel owl-theme">
                                    <div class="item">
                                        <div class="image-holder">
                                            <div class="holder-new">
                                                <div class="overlay"></div>
                                                <img src="images/shutter.jpg" alt="" class="img-responsive">
                                            </div>
                                            <ul>
                                                <li><a href="#"><i class="flaticon-profile"></i>Shamiyo</a></li>
                                                <li><a href="#"><i class="flaticon-chat"></i>245 Coments</a></li>
                                    ...
                                    <div class="item">
                                        <div class="image-holder">
                                            <div class="holder-new">
                                                <div class="overlay"></div>
                                                <img src="images/last-grl.jpg" alt="" class="img-responsive">
                                            </div>
                                            <ul>
                                                <li><a href="#"><i class="flaticon-profile"></i>Shamiyo</a></li>
                                                <li><a href="#"><i class="flaticon-chat"></i>245 Coments</a></li>
